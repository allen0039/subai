...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIOAuthService := service.ProvideOpenAIOAuthService(redisClient, proxyRepository, openAIOAuthClient, privacyClientFactory)
	...
	openAIOAuthHandler := admin.NewOpenAIOAuthHandler(openAIOAuthService, adminService, openAIQuotaService, rateLimitService, compositeTokenCacheInvalidator)
