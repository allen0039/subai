...
func TestSubAIOAuthHTTPClient_Timeout20Seconds(t *testing.T) {
	sharedReqClients = sync.Map{}
	client, err := httpclient.GetClient(httpclient.Options{ProxyURL: "http://proxy.local:8080", Timeout: 20 * time.Second})
	require.NoError(t, err)
