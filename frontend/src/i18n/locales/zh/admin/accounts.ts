    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          callbackUrlLabel: '完整回调 URL',
          callbackUrlDesc: '完成 OpenAI 登录后，复制浏览器地址栏中的完整回调 URL 并粘贴到这里。localhost 页面无法打开不影响回填；授权会话 10 分钟内有效。',
          callbackUrlRequired: '请粘贴包含 code 和 state 的完整回调 URL。',
