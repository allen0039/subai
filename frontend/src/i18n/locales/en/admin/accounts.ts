    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          step3EnterCode: 'Paste the complete callback URL',
          authCodeDesc:
          ...
          callbackUrlLabel: 'Complete callback URL',
          callbackUrlDesc: 'After signing in to OpenAI, paste the complete callback URL from your browser. The localhost page need not load. Authorization expires after 10 minutes.',
          callbackUrlRequired: 'Paste the complete callback URL containing code and state.',
