<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-primary-50 p-2 dark:bg-primary-900/20">
          <svg class="h-5 w-5 text-primary-700 dark:text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-primary-700 dark:text-primary-300">${{ formatBalance(balance) }}</p>
    ...
    <div v-if="isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-gray-100 p-2 dark:bg-dark-700">
          <Icon name="key" size="md" class="text-gray-600 dark:text-gray-300" :stroke-width="2" />
        </div>
        <div>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-gray-100 p-2 dark:bg-dark-700">
          <Icon name="cube" size="md" class="text-gray-600 dark:text-gray-300" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-gray-100 p-2 dark:bg-dark-700">
          <Icon name="dollar" size="md" class="text-gray-600 dark:text-gray-300" :stroke-width="2" />
        </div>
        <div>
  ...
  <details class="card">
    <summary class="cursor-pointer px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('dashboard.additionalMetrics') }}</summary>
    <div class="grid grid-cols-2 gap-3 border-t border-gray-200 p-3 lg:grid-cols-4 dark:border-dark-700">
    <!-- Secondary metrics -->
    <div class="min-w-0 p-2">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('dashboard.cache') }}: {{ formatTokens((stats?.total_cache_creation_tokens || 0) + (stats?.total_cache_read_tokens || 0)) }}</p>
        </div>
      </div>
    </div>
