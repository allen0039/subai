> **SubAI fork:** Full sub2api baseline with the original SubAI GPT OAuth flow. Build and deploy the custom image using [the SubAI guide](docs/subai/README.md); upstream official images do not include the login changes.
